...
/bin/bash $HOME/PrepareK8sMaster.sh $PodNetworkCIDR $ServiceCIDR $ContainerNetworkInterface $K8sVersion
/bin/bash $HOME/PrepareK8sWorker.sh $NumberOfWorkerNodes $WorkerNodeNamePrefix $WorkerNodeStatus
