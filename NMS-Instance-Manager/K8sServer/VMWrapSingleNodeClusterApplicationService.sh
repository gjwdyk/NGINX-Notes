...
file_url[6]="https://raw.githubusercontent.com/gjwdyk/NGINX-Notes/main/NMS-Instance-Manager/K8sServer/VMPrepK8sSingleNode.sh"
file_name[6]="$HOME/PrepareK8sSingleNode.sh"
file_acl[6]="777"
file_own[6]="ubuntu:ubuntu"

file_url[7]="https://raw.githubusercontent.com/gjwdyk/NGINX-Notes/main/NMS-Instance-Manager/K8sServer/PrepApplicationService.sh"
file_name[7]="$HOME/PrepareApplicationService.sh"
file_acl[7]="777"
file_own[7]="ubuntu:ubuntu"

file_url[8]="https://raw.githubusercontent.com/gjwdyk/NGINX-Notes/main/NMS-Instance-Manager/K8sServer/JigokuShoujo43x25.text"
file_name[8]="$HOME/JigokuShoujo43x25.text"
file_acl[8]="644"
